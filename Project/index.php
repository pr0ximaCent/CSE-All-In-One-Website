            ...
            <div class="row g-3">
                    ...
                    <div class="row g-3">
                        <div class="col-lg-12 col-md-12 wow zoomIn" data-wow-delay="0.1s">
                            <a class="position-relative d-block overflow-hidden" href="">
                                <img class="img-fluid" src="img/4.jpg" alt=""style="height: 520px;">
                ...
                <div class="col-lg-5 col-md-6 wow zoomIn" data-wow-delay="0.7s">
                    <a class="position-relative d-block h-100 overflow-hidden" href="">
                        ...
                        <img class="img-fluid position-absolute w-100 h-100" src="uploads/r.jpg" alt="" style="object-fit: cover;">
                        <div class="bg-white text-center position-absolute bottom-0 end-0 py-2 px-3" style="margin:  1px;">
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="team-item bg-light">
                    <div class="overflow-hidden">
                        ...
                        <img class="img-fluid" src="uploads/oss.jpg" alt="">
                        </a>
                    </div>
                    <div class="position-relative d-flex justify-content-center" style="margin-top: -23px;">
                        <div class="bg-light d-flex justify-content-center pt-2 px-1">
...
<div class="container">
    <a href="alu.html" class="flex-shrink-0 btn btn-sm btn-primary px-2 text" style="border-radius: 10px 30px 30px 10;margin-left: 590px;">
        ...
        <div class="container">
            ...
            <div class="row g-4 justify-content-center">
                    ...
                    <div class="course-item bg-light">
                        <div class="position-relative overflow-hidden">
                            ...
                            <div class="w-100 d-flex justify-content-center position-absolute bottom-0 start-0 mb-4">
                                ...
                                <a href="join.html" class="flex-shrink-0 btn btn-sm btn-primary px-3" style="border-radius: 10 30px 30px 10;margin-top: 10px;">Join Now</a>
                            </div> 
                        </div>
                    ...
                    <div class="course-item bg-light">
                        <div class="position-relative overflow-hidden">
                            ...
                            <div class="w-100 d-flex justify-content-center position-absolute bottom-0 start-0 mb-4">
                                ...
                                <a href="join.html" class="flex-shrink-0 btn btn-sm btn-primary px-3" style="border-radius: 10 30px 30px 10;">Join Now</a>
                            </div>
                        </div>
                        <div class="text-center p-4 pb-0">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="course-item bg-light">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="uploads/cvv.png" alt="">
                            <div class="w-100 d-flex justify-content-center position-absolute bottom-0 start-0 mb-4">
    ...
    <div  id="about"  class=" py-70">
         <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5">Campus Announcements</h1>
            </div>
            ...
            <div class="row about_row  py-40">
               ...
               <div class="who_we_area col-md-4 col-sm-6 col-4pad wow fadeInUp">
                  <div class="service-s">
                     <div class="servise-top wow fadeInUp">
                        <img src="uploads/nn.jpg">
                     </div>
                     <br>
                     <h3 class="Practice"> <b>Bangla Noboborsho - 1430</b></h3>
                     <p class="bottom-s">Dear CUET Community,We are delighted to announce the upcoming celebration of Bangla Noboborsho at basketball ground.
                         <br><b>Published Date:</b> 09 April 2023 </p>
               ...
               <div class="who_we_area col-md-4 col-sm-6 col-4pad wow fadeInUp">
                  <div class="service-s">
                     <div class="servise-top wow fadeInUp">
                        <img src="uploads/snn.png">
                     </div>
                     <br>
                     <h3 class="Practice"><b> Bus Service</b> </h3>
                     <p class="bottom-s">Here,We are pleased to inform you that our campus bus <br>service at CUET has been improved as per decision of the meeting of Committee.
                        <br><b>Published Date:</b> 08 April 2023 </p>
               ...
               <div class="who_we_area col-md-4 col-sm-6 col-4pad wow fadeInUp">
                  <div class="service-s">
                     <div class="servise-top wow fadeInUp">
                        <img src="uploads/sad.jpg">
                     </div>
                     <br>
                     <h3 class="Practice"><b> Self Study Registration </b></h3>
                     <p class="bottom-s">Announcing the commencement of the upcoming Self-Study Registration for the upcoming semester.
                        This time registration provides you with the opportunity...
                     <br><b>Published Date:</b> 08 April 2023 </p>
            ...
            <div class="container">
                <a href="pub.php" class="flex-shrink-0 btn btn-sm btn-primary px-2 text" style="border-radius: 10px 30px 30px 10;margin-left: 590px;">
                    <span class="view-more-text">View more</span>
              </a>
                 <!--#End about-text  --> 
    ...
    <div  id="about"  class=" py-70">
        <div class="container">
           <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
               ...
               <h1 class="mb-5">Upcoming Events Calendar</h1>
           </div>
           ...
           <div class="row about_row  py-40">
            ...
            <div class="who_we_area col-md-4 col-sm-6 col-4pad wow fadeInUp">
               <div class="service-s">
                  <div class="servise-top wow fadeInUp">
                     <img src="uploads/g.jpg">
                  </div>
                  <br>
                  <h3 class="Practice"> 𝐓𝐞𝐜𝐡 𝐂𝐚𝐫𝐧𝐢𝐯𝐚𝐥 𝟏.𝟎</h3>
                  <p class="bottom-s">𝐇𝐞𝐥𝐥𝐨, 𝐠𝐨𝐨𝐝 𝐬𝐨𝐮𝐥𝐬‼️Stressed out amidst quarantine❓ It’s time to electrify your neurons by engaging yourself with the most spectacular tech craze "𝐓𝐞𝐜𝐡 𝐂𝐚𝐫𝐧𝐢𝐯𝐚𝐥 𝟏.𝟎" presented by 𝐂𝐔𝐄𝐓 𝐂𝐨𝐦𝐩𝐮𝐭𝐞𝐫 𝐂𝐥𝐮𝐛 .
                      <br><b>Published Date:</b> 09 April 2023 </p>
            ...
            <div class="who_we_area col-md-4 col-sm-6 col-4pad wow fadeInUp">
               <div class="service-s">
                  <div class="servise-top wow fadeInUp">
                     <img src="uploads/cf.jpg">
                  </div>
                  <br>
                  <h3 class="Practice"><b>Career Fest 2023</b></h3>
                    
                  <p class="bottom-s"><b>CUET CAREER CLUB</b> presents the most anticipated Intra-University event of 2023,“CAREER FEST 2023“
                   Are you ready to take the step toward your dream career?Join us at “CAREER FEST 2023” from 1st June 2023 to 3rd June 2023.
                     <br><b>Published Date:</b> 24th May 2023 </p>
            ...
            <div class="who_we_area col-md-4 col-sm-6 col-4pad wow fadeInUp">
               <div class="service-s">
                  <div class="servise-top wow fadeInUp">
                     <img src="uploads/ll.jpg">
                  </div>
                  <br>
                  <h3 class="Practice"><b> Paper Writing from Scratch </b></h3>
                  <p class="bottom-s"><b>Everyone!!</b> We're thrilled to announce here special online session that will direct you toward pursuing higher-study.<br>Discover the essential steps to unlock your full potential at June 13th: Offline Workshop.
                  <br><b>Published Date:</b> 08 April 2023 </p>
        ...
        <div class="container">
            <a href="e_display.php" class="flex-shrink-0 btn btn-sm btn-primary px-2 text" style="border-radius: 10px 30px 30px 10;margin-left: 590px;">
                <span class="view-more-text">View more</span>
          </a>
             <!--#End about-text  --> 
     ...
     <!-- contact-->
       <div class="container-xxl py-5">
        <div class="container"">
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s"  style="padding-top:1rem;">
                    <h5>Get In Touch</h5>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s" style="padding-top:1rem;">
                    <iframe class="position-relative rounded w-100 h-500"
                        src="img/c.PNG"
...
<style>
    .view-more-text {
      font-size: 18px; /* Set the desired font size for the "View More" text */
    }
  </style>