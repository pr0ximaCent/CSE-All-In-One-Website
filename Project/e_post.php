          ...
          <body>
            <div class="hero">
               ...
               <form action="event.php" method="POST" enctype="multipart/form-data">
                ...
                <label for="title"><i class="fa-solid fa-bell"></i> Event Title</label>
              </div>
              
              <div class="input-group">
                <input type="text" id="date" name="date" placeholder="Published Date" onfocus="(this.type='date')" required>
                <label for="date"><i class="far fa-calendar-alt"></i> Event Date</label>
              </div>
               
      <div class="input-group">
              <input type="text" id="time" name="time" placeholder="Event Time" onfocus="(this.type='time')"required>
              <label for="time"><i class="fa-solid fa-clock"></i> Event Time</label>
              ...
              <div class="input-group">
                ...
                <label for="des"><i class="fa-solid fa-comment"></i>    Details</label>
              </div>
              <div class="input-group">
        ...
        <label for="image"></label>
              ...
              <a class="view-button" href="e_display.php" name="view">VIEW <i class="fa-solid fa-eye"></i></button>
              </form>
